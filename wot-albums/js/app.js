  ...
  function showLyrics(track) {
    ...
    rawLines.forEach(function(line) {
      ...
      if (isSection) {
        ...
        div.className = 'lyrics-line lyrics-line-clickable';
        div.textContent = line;
        div.setAttribute('data-content-index', contentIdx);
    ...
    lyricsContent.addEventListener('click', function(e) {
      ...
      if (!timingData || ci >= timingData.length) return;
      var lineStart = timingData[ci].start !== undefined ? timingData[ci].start : timingData[ci].time;
